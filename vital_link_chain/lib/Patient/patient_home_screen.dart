...
import 'package:vital_link_chain/Patient/patient_generate_medical_record.dart';
...
void didChangeDependencies() {
  ...
  if (!_emailLoaded) {
    ...
    print("Arguments received in PatientHomeScreen: $args");
  ...
  Widget build(BuildContext context) {
    ...
    // Method to build General Information section
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
            "This section contains general information about your health profile.",
  ...
  // Method to build Patient Access Control section
  Widget _buildPatientAccessControl() {
    return AccessControlScreen();
  }

  // Method to build Medical Record section
          ...
          child: Row(
            ...
            children: [
              Icon(
                icon, 
                size: 20, 
                color: iconColor ?? Colors.cyan, // Use iconColor if provided, otherwise default to cyan
              ),
              if (showText) ...[
                SizedBox(width: 10),
...
class _ModernHeaderSectionState extends State<ModernHeaderSection> {
  ...
  MaterialPageRoute(
    builder: (context) => MedApplication(patientAddress: address)
  ));

                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text("Dr. ${widget.doctorName}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                            SizedBox(width: 8),
                            Container(
                        ...
                        Text("License No.: ${widget.licenseNum}   Experience: 12 years", style: TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                ],

            ...
            try {
              ...
              if (certMap is Map<String, dynamic>) {
                return {
                  ...
                  "status": certMap["status"]?.toString() ?? "",
            ...
            builder: (context, snapshot) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    if (doctors.isNotEmpty) _doctorList(doctors),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _infoRow("Institution", latest["institution"]),
                                  Row(
                                    children: [
                                      const Text(
                                        "Status",
                                  ...
                                  _infoRow("Validity Period", latest["validity"]),
                                ],
                              ),
                            ),
                          ),
